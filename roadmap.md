...
- [ ] **File the Resolution Center reply — blocked on Joshua.** Draft is in `notes/appeal-4-3-spam.md` under "Lexly iOS — 6783501611". `asc web review` is read-only, so it must be pasted in the ASC web UI.
